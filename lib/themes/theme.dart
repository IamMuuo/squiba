...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      surfaceVariant: Color(4292535780),
      ...
      inversePrimary: Color(4286633172),
      primaryFixed: Color(4288475633),
      onPrimaryFixed: Color(4278198304),
      primaryFixedDim: Color(4286633172),
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      ...
      tertiaryFixed: Color(4292076799),
      onTertiaryFixed: Color(4278194727),
      tertiaryFixedDim: Color(4289972457),
